...
<body>
    ...
    <div class="section">
        ...
        <ol class="csr-list-custom">
            ...
            <li>
                <strong>PARA PIHAK</strong> menyepakati bahwa pada saat melaksanakan program Corporate Social
                Responsibility ini berdasarkan pada prinsip itikad baik, tidak saling mempengaruhi baik langsung maupun
                ...
                pertentangan kepentingan (conflict of interest), menghindari serta mencegah penyalahgunaan wewenang
                ...
                Corporate Social Responsibility ini (penyuapan).
            </li>

            <li>
                <strong>PARA PIHAK</strong> menyepakati bahwa dalam pelaksanaan program Corporate Social Responsibility
            ...
            <li>
                <strong>PIHAK KESATU</strong> dengan ini menjamin dalam pelaksanaan program Corporate Social
                Responsibility ini tidak menyalahgunakan uang dan/atau dana bantuan selain untuk tujuan sebagaimana
            ...
            <li>
                <strong>PIHAK KEDUA</strong> selaku penerima bantuan program Corporate Social Responsibility menjamin
                ...
                program Corporate Social Responsibility tersebut selain untuk tujuan dalam Kesepakatan Kerja Sama ini.
            </li>
