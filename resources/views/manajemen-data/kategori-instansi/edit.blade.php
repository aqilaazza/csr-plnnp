                ...
                <form method="POST" action="{{ route('kategori-instansi.update', $kategoriInstansi->id) }}">
                    ...
                    <div class="mb-3" id="kategori-contoh-wrapper">
                        ...
                        <input type="text" name="contoh" id="kategori-contoh-input"
                            ...
                            value="{{ old('contoh', $kategoriInstansi->contoh) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div id="sub-instansi-wrapper">
                            @php
                                ...
                                $subContohList = old('sub_instansi_contoh', $kategoriInstansi->subInstansi->pluck('contoh')->toArray());
                            @endphp
...
<script>
    ...
    // Jalankan sekali saat halaman dimuat, sesuai state sub instansi yang sudah tersimpan
    toggleKategoriContoh();
</script>
@endpush
@endsection